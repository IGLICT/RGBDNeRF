...
def add_rendering_args(parser):
    ...
    group.add_argument("--model-overrides", type=str, default=None, 
                        help="change some parameters during rendering")
    ...
    group.add_argument("--render-output-types", nargs="+", type=str, default=["rgb"], 
                        choices=["target", "color", "depth", "voxeldepth", "normal", "voxel", "predn"])
    ...
    group.add_argument("--render-camera-projs", default=None, type=str,
                       help="text file saved for projection matrices")
    ...
    group.add_argument("--render-move-vector", default="(0,0,0)", type=str, help="move voxel center")
    group.add_argument("--render-depth-rawoutput", action="store_true", help="output raw depth")